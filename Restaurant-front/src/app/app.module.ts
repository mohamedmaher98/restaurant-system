...
export function tokenGetter() {
  return localStorage.getItem('restaurantprojectrestaurantprojectrestaurantprojectrestaurantprojectrestaurantprojectrestaurantprojectrestaurantprojectrestaurantprojectrestaurantproject');
}
  ...
  imports: [
    ...
    JwtModule.forRoot({
      config: {
        ...
        blacklistedRoutes: ['localhost:4040'],
        whitelistedDomains: [
